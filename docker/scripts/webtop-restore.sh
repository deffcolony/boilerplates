...
BACKUP_DIR="/home/gebruikersnaam/docker/backups/webtop"

# Set the directory where the host volumes are mounted
HOST_VOLUME_DIR="/home/gebruikersnaam/docker/webtop"
