...
BACKUP_DIR="/home/gebruikersnaam/docker/backups/unbound"

# Set the directory where the host volumes are mounted
HOST_VOLUME_DIR="/home/gebruikersnaam/docker/unbound"
